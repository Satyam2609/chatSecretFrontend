...
export default function Signupuser(){
    ...
    <div className="min-h-screen w-full flex bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 py-6">
      ...
      <div className="hidden md:flex flex-col justify-center w-1/2 px-10">
      ...
      <div className="flex justify-center pt-10  items-center w-full md:w-1/2">
        <div className="w-full max-w-md bg-white/10 backdrop-blur-xl text-white p-8  rounded-2xl shadow-xl space-y-6 border border-white/10">
          ...
          <div className="space-y-3">
            <input type="text" placeholder="Username" onChange={handleChanges} value={formdata.username} name="username"
              className="w-full px-2 py-2 bg-white/20 border border-white/20 rounded-xl focus:border-emerald-400 outline-none"/>
            ...
            <input type="file" onChange={handleChanges} name="avatar" accept="/*"
              className="w-full p-3 bg-white/20 border border-white/20 rounded-xl cursor-pointer"/>
